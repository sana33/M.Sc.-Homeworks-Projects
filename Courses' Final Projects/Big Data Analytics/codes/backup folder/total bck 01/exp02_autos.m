...
[OS,OSidx,Jopt,OF,UO] = ITB_SP(autos(:,[1:3 5:end]),size(autos,1),0);
[X,Y,~,AUC] = perfcurve(autos(:,4),OF,1);
...
[OS,OSidx,Jopt,OF,UO] = ITB_SP(autos(:,[1:3 5:end]),size(autos,1),1);
[X,Y,~,AUC] = perfcurve(autos(:,4),OF,1);
figure; plot(X,Y,'r','LineWidth',1.5); grid on;
...
[OS,OSidx,Jopt,OF,UO] = ITB_SS(autos(:,[1:3 5:end]),size(autos,1),0);
[X,Y,~,AUC] = perfcurve(autos(:,4),OF,1);
figure; plot(X,Y,'r','LineWidth',1.5); grid on;
...
[OS,OSidx,Jopt,OF,UO] = ITB_SS(autos(:,[1:3 5:end]),size(autos,1),1);
[X,Y,~,AUC] = perfcurve(autos(:,4),OF,1);
figure; plot(X,Y,'r','LineWidth',1.5); grid on;
