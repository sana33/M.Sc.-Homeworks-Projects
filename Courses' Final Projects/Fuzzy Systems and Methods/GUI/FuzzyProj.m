...
[m_f,M_inv,W_GK,hFP_GK] = GK_clust(X,k,alpha,stopCond,maxIter,rho,hFP_GK,hObject,handles);
axes(hFP_GK);
title('The Final Result of GK Clutering Algorithm');

% Performing Fuzzy C-Means (FCM)
hFP_FCM = handles.axes3;
[V,W_FCM,hFP_FCM] = FCM(X,k,alpha,stopCond,maxIter,hFP_FCM,hObject,handles);
axes(hFP_FCM);
